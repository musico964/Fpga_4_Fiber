...
# ----------------------------------------------------------------
	...
	for {set i 0} {$i < $dqsgroups} {incr i} {
		set dqs ${instname}_alt_mem_phy_inst|dpio|dqs\[$i\].dqs_io|outclk
		set dq  ${instname}_alt_mem_phy_inst|dpio|dqs_group\[$i\].dq[*].dq_io|outclk
		set dm  ${instname}_alt_mem_phy_inst|dpio|dm\[$i\].dm_pin|auto_generated|ddio_outa\[*\]|outclk
	...
	set patterns [list]
lappend patterns addrcmd_2t ${instname}_alt_mem_phy_inst|*adc*|addr\[*\].addr_struct|half_rate.addr_pin|auto_generated|ddio_outa\[*\]|outclk
lappend patterns addrcmd_2t ${instname}_alt_mem_phy_inst|*adc*|ba\[*\].ba_struct|half_rate.addr_pin|auto_generated|ddio_outa\[*\]|outclk
lappend patterns addrcmd_2t ${instname}_alt_mem_phy_inst|*adc*|cas_n_struct|half_rate.addr_pin|auto_generated|ddio_outa\[*\]|outclk
lappend patterns addrcmd_2t ${instname}_alt_mem_phy_inst|*adc*|ras_n_struct|half_rate.addr_pin|auto_generated|ddio_outa\[*\]|outclk
lappend patterns addrcmd_2t ${instname}_alt_mem_phy_inst|*adc*|we_n_struct|half_rate.addr_pin|auto_generated|ddio_outa\[*\]|outclk
lappend patterns addrcmd ${instname}_alt_mem_phy_inst|*adc*|cke\[*\].cke_struct|half_rate.addr_pin|auto_generated|ddio_outa\[*\]|outclk
lappend patterns addrcmd ${instname}_alt_mem_phy_inst|*adc*|gen_odt.odt\[*\].odt_struct|half_rate.addr_pin|auto_generated|ddio_outa\[*\]|outclk
lappend patterns addrcmd ${instname}_alt_mem_phy_inst|*adc*|cs_n\[*\].cs_n_struct|half_rate.addr_pin|auto_generated|ddio_outa\[*\]|outclk
lappend patterns ck_p ${instname}_alt_mem_phy_inst|clk|DDR_CLK_OUT\[*\].ddr_clk_out_p|outclk
lappend patterns ck_n ${instname}_alt_mem_phy_inst|clk|DDR_CLK_OUT\[*\].ddr_clk_out_n|outclk
	...
	set outputFileName "Ddr2SdramIf_phy_autodetectedpins.tcl"
