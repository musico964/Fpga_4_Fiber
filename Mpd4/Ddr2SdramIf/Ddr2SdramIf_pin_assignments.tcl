# -------------------------------------------------------------------------
#
# ALTMEMPHY v13.0 DDR2 SDRAM pin constraints script for Ddr2SdramIf
#
...
set mem_clk_STRATIXII_TERMINATION "SERIES 50 OHMS WITHOUT CALIBRATION"

set mem_clk_n_pin_name ${pin_prefix}clk_n
set mem_clk_n_IO_STANDARD "SSTL-18 CLASS I"
set mem_clk_n_STRATIXII_TERMINATION "SERIES 50 OHMS WITHOUT CALIBRATION"
...
set mem_dq_IO_STANDARD "SSTL-18 CLASS II"
set mem_dq_STRATIXII_TERMINATION "SERIES 25 OHMS WITHOUT CALIBRATION"

set mem_dqs_pin_name ${pin_prefix}dqs
set mem_dqs_IO_STANDARD "SSTL-18 CLASS II"
set mem_dqs_STRATIXII_TERMINATION "SERIES 25 OHMS WITHOUT CALIBRATION"

set mem_dm_pin_name ${pin_prefix}dm
set mem_dm_IO_STANDARD "SSTL-18 CLASS I"
set mem_dm_STRATIXII_TERMINATION "SERIES 50 OHMS WITHOUT CALIBRATION"
...
set_instance_assignment -name GLOBAL_SIGNAL "DUAL-REGIONAL CLOCK" -to "*Ddr2SdramIf*_clk4"
...
set_instance_assignment -name STRATIXII_TERMINATION "${mem_clk_STRATIXII_TERMINATION}" -to ${mem_clk_pin_name}${single_bit}
set_instance_assignment -name IO_STANDARD "${mem_clk_n_IO_STANDARD}" -to ${mem_clk_n_pin_name}${single_bit}
set_instance_assignment -name STRATIXII_TERMINATION "${mem_clk_n_STRATIXII_TERMINATION}" -to ${mem_clk_n_pin_name}${single_bit}
...
set_instance_assignment -name STRATIXII_TERMINATION "${mem_dq_STRATIXII_TERMINATION}" -to ${mem_dq_pin_name}[0]
set_instance_assignment -name IO_STANDARD "${mem_dq_IO_STANDARD}" -to ${mem_dq_pin_name}[1]
set_instance_assignment -name STRATIXII_TERMINATION "${mem_dq_STRATIXII_TERMINATION}" -to ${mem_dq_pin_name}[1]
set_instance_assignment -name IO_STANDARD "${mem_dq_IO_STANDARD}" -to ${mem_dq_pin_name}[2]
set_instance_assignment -name STRATIXII_TERMINATION "${mem_dq_STRATIXII_TERMINATION}" -to ${mem_dq_pin_name}[2]
set_instance_assignment -name IO_STANDARD "${mem_dq_IO_STANDARD}" -to ${mem_dq_pin_name}[3]
set_instance_assignment -name STRATIXII_TERMINATION "${mem_dq_STRATIXII_TERMINATION}" -to ${mem_dq_pin_name}[3]
set_instance_assignment -name IO_STANDARD "${mem_dq_IO_STANDARD}" -to ${mem_dq_pin_name}[4]
set_instance_assignment -name STRATIXII_TERMINATION "${mem_dq_STRATIXII_TERMINATION}" -to ${mem_dq_pin_name}[4]
set_instance_assignment -name IO_STANDARD "${mem_dq_IO_STANDARD}" -to ${mem_dq_pin_name}[5]
set_instance_assignment -name STRATIXII_TERMINATION "${mem_dq_STRATIXII_TERMINATION}" -to ${mem_dq_pin_name}[5]
set_instance_assignment -name IO_STANDARD "${mem_dq_IO_STANDARD}" -to ${mem_dq_pin_name}[6]
set_instance_assignment -name STRATIXII_TERMINATION "${mem_dq_STRATIXII_TERMINATION}" -to ${mem_dq_pin_name}[6]
set_instance_assignment -name IO_STANDARD "${mem_dq_IO_STANDARD}" -to ${mem_dq_pin_name}[7]
set_instance_assignment -name STRATIXII_TERMINATION "${mem_dq_STRATIXII_TERMINATION}" -to ${mem_dq_pin_name}[7]
set_instance_assignment -name IO_STANDARD "${mem_dqs_IO_STANDARD}" -to ${mem_dqs_pin_name}${single_bit}
set_instance_assignment -name STRATIXII_TERMINATION "${mem_dqs_STRATIXII_TERMINATION}" -to ${mem_dqs_pin_name}${single_bit}
set_instance_assignment -name IO_STANDARD "${mem_dm_IO_STANDARD}" -to ${mem_dm_pin_name}${single_bit}
set_instance_assignment -name STRATIXII_TERMINATION "${mem_dm_STRATIXII_TERMINATION}" -to ${mem_dm_pin_name}${single_bit}
set_instance_assignment -name OUTPUT_ENABLE_GROUP "564257642" -to ${mem_dq_pin_name}[0]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "564257642" -to ${mem_dq_pin_name}[1]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "564257642" -to ${mem_dq_pin_name}[2]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "564257642" -to ${mem_dq_pin_name}[3]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "564257642" -to ${mem_dq_pin_name}[4]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "564257642" -to ${mem_dq_pin_name}[5]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "564257642" -to ${mem_dq_pin_name}[6]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "564257642" -to ${mem_dq_pin_name}[7]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "564257642" -to ${mem_dqs_pin_name}${single_bit}
set_instance_assignment -name OUTPUT_ENABLE_GROUP "564257642" -to ${mem_dm_pin_name}${single_bit}
