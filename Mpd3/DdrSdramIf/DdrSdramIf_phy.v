...
module DdrSdramIf_phy (
	...
	DdrSdramIf_phy_alt_mem_phy	DdrSdramIf_phy_alt_mem_phy_inst(
	...
	defparam
		DdrSdramIf_phy_alt_mem_phy_inst.FAMILY = "Arria GX",
		DdrSdramIf_phy_alt_mem_phy_inst.MEM_IF_MEMTYPE = "DDR",
		DdrSdramIf_phy_alt_mem_phy_inst.DLL_DELAY_BUFFER_MODE = "HIGH",
		DdrSdramIf_phy_alt_mem_phy_inst.DLL_DELAY_CHAIN_LENGTH = 16,
		DdrSdramIf_phy_alt_mem_phy_inst.DQS_DELAY_CTL_WIDTH = 6,
		DdrSdramIf_phy_alt_mem_phy_inst.DQS_OUT_MODE = "DELAY_CHAIN3",
		DdrSdramIf_phy_alt_mem_phy_inst.DQS_PHASE = 6750,
		DdrSdramIf_phy_alt_mem_phy_inst.DQS_PHASE_SETTING = 3,
		DdrSdramIf_phy_alt_mem_phy_inst.DWIDTH_RATIO = 4,
		DdrSdramIf_phy_alt_mem_phy_inst.MEM_IF_DWIDTH = 8,
		DdrSdramIf_phy_alt_mem_phy_inst.MEM_IF_ADDR_WIDTH = 13,
		DdrSdramIf_phy_alt_mem_phy_inst.MEM_IF_BANKADDR_WIDTH = 2,
		DdrSdramIf_phy_alt_mem_phy_inst.MEM_IF_CS_WIDTH = 2,
		DdrSdramIf_phy_alt_mem_phy_inst.MEM_IF_CS_PER_RANK = 1,
		DdrSdramIf_phy_alt_mem_phy_inst.MEM_IF_DM_WIDTH = 1,
		DdrSdramIf_phy_alt_mem_phy_inst.MEM_IF_DM_PINS_EN = 1,
		DdrSdramIf_phy_alt_mem_phy_inst.MEM_IF_DQ_PER_DQS = 8,
		DdrSdramIf_phy_alt_mem_phy_inst.MEM_IF_DQS_WIDTH = 1,
		DdrSdramIf_phy_alt_mem_phy_inst.MEM_IF_OCT_EN = 0,
		DdrSdramIf_phy_alt_mem_phy_inst.MEM_IF_CLK_PAIR_COUNT = 1,
		DdrSdramIf_phy_alt_mem_phy_inst.MEM_IF_CLK_PS = 5000,
		DdrSdramIf_phy_alt_mem_phy_inst.MEM_IF_CLK_PS_STR = "5000 ps",
		DdrSdramIf_phy_alt_mem_phy_inst.MEM_IF_MR_0 = 51,
		DdrSdramIf_phy_alt_mem_phy_inst.MEM_IF_MR_1 = 0,
		DdrSdramIf_phy_alt_mem_phy_inst.MEM_IF_MR_2 = 0,
		DdrSdramIf_phy_alt_mem_phy_inst.MEM_IF_MR_3 = 0,
		DdrSdramIf_phy_alt_mem_phy_inst.PLL_STEPS_PER_CYCLE = 24,
		DdrSdramIf_phy_alt_mem_phy_inst.SCAN_CLK_DIVIDE_BY = 2,
		DdrSdramIf_phy_alt_mem_phy_inst.MEM_IF_DQSN_EN = 0,
		DdrSdramIf_phy_alt_mem_phy_inst.DLL_EXPORT_IMPORT = "EXPORT",
		DdrSdramIf_phy_alt_mem_phy_inst.MEM_IF_ADDR_CMD_PHASE = 90,
		DdrSdramIf_phy_alt_mem_phy_inst.RANK_HAS_ADDR_SWAP = 0,
		DdrSdramIf_phy_alt_mem_phy_inst.DEDICATED_MEMORY_CLK_EN = 0;
endmodule
...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.DDRPHYMVCModel"  active_core="DdrSdramIf_phy_alt_mem_phy" >
...
// Retrieval info:      <PRIVATE name = "mem_if_preset" value="Custom (Micron MT46V64M8P-5B)"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "mem_if_coladdr_width" value="11"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "alt_top" value="DdrSdramIf_phy_alt_mem_phy_seq_wrapper"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "family" value="Arria GX"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "filename" value="DdrSdramIf_phy_alt_mem_phy_seq_wrapper.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "simgen2">
// Retrieval info:      <PRIVATE name = "family" value="Arria GX"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "command" value="--simgen_arbitrary_blackbox=+DdrSdramIf_phy_alt_mem_phy_seq_wrapper;+DdrSdramIf_phy_alt_mem_phy_reconfig;+DdrSdramIf_phy_alt_mem_phy_pll;+DdrSdramIf_phy_alt_mem_phy_delay --ini=simgen_tri_bus_opt=on"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=C:\Users\musico\Documents\INFN\Jlab12\Fpga_Mpd3_Mpd4\Fpga_4\Mpd3\DdrSdramIf/DdrSdramIf_phy_simgen_init.txt"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// Retrieval info:      <PRIVATE name = "filename" value="DdrSdramIf_phy_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "quartus_settings">
// Retrieval info:      <PRIVATE name = "DEVICE" value="EP1AGX50DF780C6"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "FAMILY" value="Arria GX"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// =========================================================
// IPFS_FILES: DdrSdramIf_phy_alt_mem_phy_seq_wrapper.vo;
// =========================================================
