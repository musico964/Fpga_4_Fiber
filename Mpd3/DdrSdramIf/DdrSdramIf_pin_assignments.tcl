# -------------------------------------------------------------------------
#
# ALTMEMPHY v13.0 DDR SDRAM pin constraints script for DdrSdramIf
#
...
set_instance_assignment -name OUTPUT_ENABLE_GROUP "398366216" -to ${mem_dq_pin_name}[0]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "398366216" -to ${mem_dq_pin_name}[1]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "398366216" -to ${mem_dq_pin_name}[2]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "398366216" -to ${mem_dq_pin_name}[3]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "398366216" -to ${mem_dq_pin_name}[4]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "398366216" -to ${mem_dq_pin_name}[5]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "398366216" -to ${mem_dq_pin_name}[6]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "398366216" -to ${mem_dq_pin_name}[7]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "398366216" -to ${mem_dqs_pin_name}${single_bit}
set_instance_assignment -name OUTPUT_ENABLE_GROUP "398366216" -to ${mem_dm_pin_name}${single_bit}
