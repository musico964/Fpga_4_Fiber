...
module DdrSdramIf (
	...
	DdrSdramIf_controller_phy	DdrSdramIf_controller_phy_inst(
...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.DDRControllerMVCModel"  active_core="DdrSdramIf_controller_phy" >
...
// Retrieval info:      <PRIVATE name = "alt_top" value="DdrSdramIf_alt_mem_ddrx_controller_top"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "nativelink_excludes" value="DdrSdramIf_phy_alt_mem_phy_seq.vhd,DdrSdramIf_phy_alt_mem_phy_seq_wrapper.vhd,DdrSdramIf_phy_alt_mem_phy_seq_wrapper.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "family" value="Arria GX"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "native" value="verilog"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "filename" value="DdrSdramIf_alt_mem_ddrx_controller_top.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "simgen2">
// Retrieval info:      <PRIVATE name = "family" value="Arria GX"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "command" value="--simgen_arbitrary_blackbox=+DdrSdramIf_alt_mem_phy_seq_wrapper;+DdrSdramIf_alt_mem_phy_reconfig;+DdrSdramIf_alt_mem_phy_pll;+DdrSdramIf_phy_alt_mem_phy_delay --ini=simgen_tri_bus_opt=on"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=C:\Users\musico\Documents\INFN\Jlab12\Fpga_Mpd3_Mpd4\Fpga_4\Mpd3\DdrSdramIf/DdrSdramIf_simgen_init.txt"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// Retrieval info:      <PRIVATE name = "filename" value="DdrSdramIf_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
