...
//altasmi_parallel CBX_AUTO_BLACKBOX="ALL" DATA_WIDTH="STANDARD" DEVICE_FAMILY="Arria GX" EPCS_TYPE="EPCS128" PAGE_SIZE=1 PORT_BULK_ERASE="PORT_UNUSED" PORT_DIE_ERASE="PORT_UNUSED" PORT_EN4B_ADDR="PORT_UNUSED" PORT_FAST_READ="PORT_UNUSED" PORT_ILLEGAL_ERASE="PORT_USED" PORT_ILLEGAL_WRITE="PORT_USED" PORT_RDID_OUT="PORT_USED" PORT_READ_ADDRESS="PORT_UNUSED" PORT_READ_DUMMYCLK="PORT_UNUSED" PORT_READ_RDID="PORT_USED" PORT_READ_SID="PORT_UNUSED" PORT_READ_STATUS="PORT_USED" PORT_SECTOR_ERASE="PORT_USED" PORT_SECTOR_PROTECT="PORT_UNUSED" PORT_SHIFT_BYTES="PORT_UNUSED" PORT_WREN="PORT_UNUSED" PORT_WRITE="PORT_USED" USE_ASMIBLOCK="ON" USE_EAB="ON" WRITE_DUMMY_CLK=0 addr busy clkin data_valid datain dataout illegal_erase illegal_write rden rdid_out read read_rdid read_status reset sector_erase status_out write INTENDED_DEVICE_FAMILY="Arria GX" ALTERA_INTERNAL_OPTIONS=SUPPRESS_DA_RULE_INTERNAL=C106
...
//synthesis_resources = a_graycounter 4 arriagx_asmiblock 1 lut 15 mux21 1 reg 117 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"SUPPRESS_DA_RULE_INTERNAL=C106"} *)
module  z_asmi_altasmi_parallel_uol2
	( 
	addr,
	busy,
	clkin,
...
`endif
	...
	wire  wire_stratixii_asmiblock2_data0out;
	wire  addr_overdie;
	...
	assign
		wire_statreg_out_ena = {8{(((((((end_operation & do_read_stat) & (~ do_write)) & (~ do_sec_erase)) & (~ do_die_erase)) & (~ do_bulk_erase)) & (~ do_sec_prot)) & (~ do_4baddr))}};
	// synopsys translate_off
	initial
		write_prot_reg = 0;
	// synopsys translate_on
	...
	arriagx_asmiblock   stratixii_asmiblock2
	( 
	...
	assign
		...
		illegal_write_b4out_wire = (((do_write & write_prot_true) | (illegal_write_prot & write_prot_true2)) | (do_write & (~ pagewr_buf_not_empty[0]))),
...
endmodule //z_asmi_altasmi_parallel_uol2
//VALID FILE
...
module z_asmi (
	...
	illegal_write,
	rdid_out,
	status_out)/* synthesis synthesis_clearbox = 2 */;
	...
	wire [7:0] rdid_out = sub_wire3[7:0];
	wire  busy = sub_wire4;
	wire [7:0] status_out = sub_wire5[7:0];
	wire  illegal_write = sub_wire6;

	z_asmi_altasmi_parallel_uol2	z_asmi_altasmi_parallel_uol2_component (
				.clkin (clkin),
				.datain (datain),
				.rden (rden),
				.read_rdid (read_rdid),
				...
				.illegal_write (sub_wire6))/* synthesis synthesis_clearbox=2
	 clearbox_macroname = ALTASMI_PARALLEL
	 clearbox_defparam = "data_width=STANDARD;epcs_type=EPCS128;intended_device_family=Arria GX;lpm_hint=UNUSED;lpm_type=altasmi_parallel;page_size=1;port_bulk_erase=PORT_UNUSED;port_die_erase=PORT_UNUSED;port_en4b_addr=PORT_UNUSED;port_fast_read=PORT_UNUSED;port_illegal_erase=PORT_USED;port_illegal_write=PORT_USED;port_rdid_out=PORT_USED;port_read_address=PORT_UNUSED;port_read_dummyclk=PORT_UNUSED;port_read_rdid=PORT_USED;port_read_sid=PORT_UNUSED;port_read_status=PORT_USED;port_sector_erase=PORT_USED;port_sector_protect=PORT_UNUSED;port_shift_bytes=PORT_UNUSED;port_wren=PORT_UNUSED;port_write=PORT_USED;use_asmiblock=ON;use_eab=ON;write_dummy_clk=0;" */;
...
// Retrieval info: GEN_FILE: TYPE_NORMAL z_asmi.v TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL z_asmi.qip TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL z_asmi.bsf FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL z_asmi_inst.v TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL z_asmi_bb.v FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL z_asmi.inc FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL z_asmi.cmp FALSE TRUE
